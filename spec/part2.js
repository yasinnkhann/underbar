  ...
  describe('Part II', function() {
    ...
    describe('memoize', function() {
      ...
      it('should return a stored result from a memoized function, after function is run once', function() {
        var spyAdd = sinon.spy(add)
        var spyMemoAdd = _.memoize(spyAdd);
        expect(spyMemoAdd(1, 2)).to.equal(3);
        expect(spyMemoAdd(1, 2)).to.equal(3);
        expect(spyAdd).to.have.been.calledOnce;
        expect(spyMemoAdd(3, 4)).to.equal(7);
        expect(spyMemoAdd(3, 4)).to.equal(7);
